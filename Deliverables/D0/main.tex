...
\fancyfoot[C]{\fontsize{6.5}{8}\selectfont\color{gray} CS455 -- Deliverable 0: Project Proposal \quad|\quad Page \thepage}
...
\twocolumn[
  ...
  \vspace{3pt}
  {\sffamily\small CS455: Introduction to Software Engineering \ {\textbullet}\
    Deliverable 0 -- Project Proposal \ {\textbullet}\
    Instructor: Dr.\ Priyanka Bagade, IIT Kanpur}\par
  \vspace{5pt}
  {\small
